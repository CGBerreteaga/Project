...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] InputActionMap currentActionMap;
    ...
    private void Start()
    {
        ...
        currentActionMap = playerInput.FindActionMap("Player");
    ...
    void SwitchActionMap()
    {
        ...
        currentActionMap = (currentActionMap.name == "Player") ? playerInput.FindActionMap("Menu") : playerInput.FindActionMap("Player");

        if (currentActionMap == null)
        {
            Debug.LogError("Action Map not found in InputActionAsset.");
            return;
        }
